...
public:
    /**
     * @brief Resets the slide-in animation state (called when switching to this screen).
     */
     ...
     */
    void draw(float dt, DisplayManager& display, const DHTSensor& dhtSensor, const AppState& appState);
